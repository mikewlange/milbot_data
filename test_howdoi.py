...
class HowdoiTestCase(unittest.TestCase):
    ...
    def test_unicode_answer(self):
        print self.call_howdoi('QUERY hire a layer')
        print self.call_howdoi('QUERY what is row vs wade')

        print self.call_howdoi('QUERY sell a house')
        print self.call_howdoi('QUERY file a law suite')
